...
Future<void> updatePassword(
    String instructorId, String enrollment_no, String oldPassword, String newPassword) async {
  var headers = {
  ...
  var uri =
      Uri.parse('https://newsdcattendance.onrender.com/resetPassword');
...
class _ForgetPasswordPageState extends State<ForgetPasswordPage> {
  ...
  final TextEditingController enrollment_noController = TextEditingController();
  ...
  void initState() {
    super.initState();
    enrollment_noController.addListener(() {Text("NA");});
                                      ...
                                      child: Column(children: <Widget>[
                                        ...
                                        Container(
                                          ...
                                          child: ElevatedButton(
                                              ...
                                              onPressed: () async {
                                                String enrollment_no = enrollment_noController.text;
                                                String instructorId =
                                                ...
                                                updatePassword(instructorId,enrollment_no, 
